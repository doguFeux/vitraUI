...
Felece.Tabber = {
    ...
    Actions: {
        init: function () {
            Felece.Tabber.Helper.setCurrent();
            Felece.Tabber.Helper.setElements();

            // Get shortcut objects.
            var elements = Felece.Tabber.Elements;
            ...
            for (ti = 0; ti < elements.tabberHeadItems.length; ti++) {
                ...
                tabberHeadItem.addEventListener("click", function () {
                    Felece.Tabber.Actions.show({ sender: this });
                });
            }

            // Prepare tabbers by url query string
            Felece.Tabber.Actions.prepareByUrl();
        },
        ...
        mfInit: function (arg) {
            ...
            // Get shortcut objects.
            var props = Felece.Tabber.Props;
            var current = Felece.Tabber.Current;
            ...
            if (tabberContentMfItems.length) {
                Felece.Base.microFrontendSetup({ mfElements: tabberContentMfItems });
            }
        ...
        show: function (arg) {
            ...
            if (!Felece.Tabber.Current.isUrlSetup) {
            ...
            Felece.Tabber.Helper.setContentProps();

            // Prepare UX
            Felece.Tabber.UX.show();
        },
        ...
        scrollAndShow: function (arg) {
            ...
            var headerHeight = Felece.Globals.headerElem.offsetHeight; // in case header is fixed!
            var scrollTopVal = parseInt(Felece.Base.Props.Scroll.Y.currval + rect.top - headerHeight - 50);
            ...
            Felece.Tabber.Helper.yScrollToTabHeadItem({ _tabberContainerEl: tabberContainerEl, _tabHeadItemEl: tabHeadItemEl });
        },
                ...
                setTimeout(function () {
                    for (var u = 0; u < props.tabberContainerIdArrByUrl.length; u++) {
                        ...
                        if (tabberContainerEl_) {
                            ...
                            Felece.Tabber.Helper.yScrollToTabHeadItem({ _tabberContainerEl: tabberContainerEl_, _tabHeadItemEl: tabHeadItemEl_ });
                        }
                    }
                }, 400);
            }
        ...
        show: function () {
            ...
            if (!current.isUrlSetup) {
                updateUrlQueryString({
                    ...
                    queryString_tbr: Felece.Tabber.Helper.buildUrl().join('|')
                });
            }
