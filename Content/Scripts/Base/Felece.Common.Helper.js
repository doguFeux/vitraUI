...
// Dynamic function call --> executeFunction(sender, "Felece.Address.setSelectedOnChange", "1|2|3");
...
function formReset(arg) {
    ...
    if (Felece.hasOwnProperty("Validation")) {
        Felece.Validation.Actions.clear({ selector: arg.selector });
    }
}
